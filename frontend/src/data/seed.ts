...
export const SEED_PROFILE: AgentProfile = {
  ...
  organisation: "Interministerial Digital Directorate (DINUM)",
...
export const SEED_HOME_ACTIVITIES: HomeActivity[] = [
  ...
  { id: "a2", icon: "meeting", iconBg: "#e3e3fd", label: "Welcome and check-in meeting", dueLabel: "D+1" },
  { id: "a3", icon: "equipment", iconBg: "#d7f5e3", label: "IT equipment handover", dueLabel: "D+1" },
  { id: "a4", icon: "tour", iconBg: "#fbe0f0", label: "Office tour", dueLabel: "D+1" },
];
